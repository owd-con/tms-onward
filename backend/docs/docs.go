        ...
        "/dashboard": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Month filter in YYYY-MM format (e.g., 2026-03). Defaults to current month if not provided.",
                        "name": "month",
                        "in": "query"
                    },
                    {
        ...
        "/reports/order-trip-waypoint": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by waypoint status (pending/in_progress/completed)",
                        "name": "status",
                        "in": "query"
                    },
                    {
        ...
        "/waypoint/images": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by trip waypoint ID",
                        "name": "trip_waypoint_id",
                        "in": "query"
                    },
                    {
                        "type": "integer",
