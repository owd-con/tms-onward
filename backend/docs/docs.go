...
const docTemplate = `{
    ...
    "paths": {
        "/addresses": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Customer ID to filter addresses by customer (optional - if not provided, returns all company addresses)",
                        "name": "customer_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by address name (partial match)",
                        "name": "name",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/address.createRequest"
                        }
                    },
                    {
                        "type": "string",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/address.updateRequest"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/companies": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by status: active or inactive (default: all)",
                        "name": "status",
                        "in": "query"
                    },
                    {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/company.updateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/driver/trips/waypoint/{id}/complete": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Presigned S3 URL for customer signature image",
                        "name": "signature_url",
                        "in": "body",
                        "required": true,
                        "schema": {
                    ...
                    {
                        "minLength": 1,
                        "description": "Array of presigned S3 URLs for delivery photos",
                        "name": "images",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/driver/trips/waypoint/{id}/failed": {
            "put": {
                "description": "Mark waypoint as failed with reason and images (In Transit → Completed/Failed). Failed reason must be one of: address_not_found, recipient_unavailable, refused_to_accept, damaged_goods, wrong_address, other",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    {
                        "minLength": 1,
                        "description": "Array of presigned S3 URLs for failure documentation photos",
                        "name": "images",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/driver/trips/waypoint/{id}/start": {
            "put": {
        ...
        "/drivers": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "SIM_A / SIM_B1 / SIM_B2 / SIM_C",
                        "name": "license_type",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "name / license_number",
                        "name": "search",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create driver with user login access",
                        "name": "has_login",
                        "in": "body",
                        "schema": {
                            "type": "boolean"
                    ...
                    {
                        "description": "User email (required if has_login=true)",
                        "name": "email",
                        "in": "body",
                        "schema": {
                            "type": "string"
                    ...
                    {
                        "description": "User password (required if has_login=true)",
                        "name": "password",
                        "in": "body",
                        "schema": {
                            "type": "string"
                    ...
                    {
                        "description": "Password confirmation (required if has_login=true)",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/driver.createRequest"
                        }
                    },
                    {
                        "type": "string",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/driver.updateRequest"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/onboarding/step1": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Company profile update request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/onboarding.step1Request"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/onboarding/step2": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create/update users request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/onboarding.step2Request"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/onboarding/step3": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create/update vehicles request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/onboarding.step3Request"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/onboarding/step4": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create/update drivers request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/onboarding.step4Request"
                        }
                    },
                    {
                        "type": "string",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/onboarding.step5Request"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/orders/{order_id}/waypoints/{waypoint_id}/images": {
            "get": {
                "description": "Get all images (POD/failed) for a specific waypoint",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/orders/{order_id}/waypoints/{waypoint_id}/logs": {
            "get": {
                "description": "Get all logs for a specific waypoint",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/pricing-matrices": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by origin city ID",
                        "name": "origin_city_id",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Order by field (id/-id)",
                        "name": "order_by",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Pricing matrix data",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pricing_matrix.createRequest"
                        }
                    },
                    {
                        "type": "string",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pricing_matrix.updateRequest"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/pricing-matrices/{id}/deactivate": {
            "put": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/trip.createRequest"
                        }
                    },
                    {
                        "type": "string",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/trip.updateRequest"
                        }
                    },
                    {
                        "type": "string",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/upload.presignedURLRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/vehicles": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Truck / Van / Pickup / Container Truck / Trailer",
                        "name": "vehicle_type",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/vehicle.createRequest"
                        }
                    },
                    {
                        "type": "string",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/vehicle.updateRequest"
                        }
                    },
                    {
                        "type": "string",
    ...
    "definitions": {
        ...
        "address.updateRequest": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "From path parameter",
                    "type": "string"
                },
                "name": {
                    "type": "string"
        ...
        "driver.updateRequest": {
            ...
            "properties": {
                ...
                "has_login": {
                    "description": "Add login account fields (one-way: no login → has login)",
                    "type": "boolean"
                },
                "id": {
                    "type": "string"
        ...
        "onboarding.step2Request": {
            "type": "object",
            "properties": {
                "users": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/onboarding.userRequest"
                    }
                }
            }
        },
        "onboarding.step3Request": {
            "type": "object",
            "properties": {
                "vehicles": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/onboarding.vehicleRequest"
                    }
                }
            }
        },
        "onboarding.step4Request": {
            "type": "object",
            "properties": {
                "drivers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/onboarding.driverRequest"
                    }
                }
            }
        },
        ...
        "upload.presignedURLRequest": {
            "type": "object",
            "properties": {
                "contentType": {
                    "description": "Content type (misal: \"image/jpeg\")",
                    "type": "string"
                },
                "filename": {
                    "description": "Nama file (misal: \"signature.jpg\")",
                    "type": "string"
                }
            }
        },
