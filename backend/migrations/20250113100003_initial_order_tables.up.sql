...
CREATE TABLE IF NOT EXISTS pods (
    ...
    CONSTRAINT fk_pods_order_waypoint FOREIGN KEY (order_waypoint_id) REFERENCES order_waypoints(id)
);

CREATE INDEX idx_pods_order_waypoint_id ON pods(order_waypoint_id);
