...
const OnboardingCompletePage = ({ data, onGoToDashboard }: OnboardingCompletePageProps) => {
  const stats = [
    {
    ...
    },
    {
      ...
      color: data.step2.usersCreated > 0 ? "text-success" : "text-base-content/40",
    },
    {
      label: "Vehicles",
      value: `${data.step3.vehiclesCreated} added`,
      icon: data.step3.vehiclesCreated > 0 ? <HiCheckCircle size={20} /> : null,
      color: data.step3.vehiclesCreated > 0 ? "text-success" : "text-base-content/40",
    },
    {
      label: "Drivers",
              ...
              <div className="bg-base-200 rounded-xl p-4 space-y-3">
                {stats.map((stat, index) => (
                  ...
                  >
                    ...
                    <span className="text-sm text-base-content/70">{stat.value}</span>
                  </div>
                ))}
              </div>
            </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-success/80 text-xs">
                      Great job! You've added {totalItemsAdded} item{totalItemsAdded !== 1 ? "s" : ""} to get
                      started. You can always add more from the management pages.
                    </div>
                  </div>
                </div>
              </div>
