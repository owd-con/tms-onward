      ...
      <div className="flex flex-col h-full bg-slate-50">
        ...
        <div className="px-6 py-5 bg-white border-b border-slate-200 flex justify-between items-start shrink-0">
          <div className="flex gap-3 items-center">
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${headerColors}`}>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
            <h3 className="text-sm font-bold text-slate-900 mb-4 uppercase tracking-wider">Resources</h3>
          ...
          {/* Notes */}
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
            <h3 className="text-sm font-bold text-slate-900 mb-4 uppercase tracking-wider">Additional Info</h3>
            <Input
              id="trip-notes"
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
             <div className="flex justify-between items-center mb-4">
                <h3 className="text-sm font-bold text-slate-900 uppercase tracking-wider">Routing Sequence</h3>
                <span className="text-[10px] font-bold text-primary bg-primary/10 px-2 py-0.5 rounded-md uppercase">Auto-generated</span>
             </div>
             
             {!orderDetail ? (
               <div className="text-center py-8 text-slate-500 text-sm">Loading routing sequence...</div>
             ) : (
