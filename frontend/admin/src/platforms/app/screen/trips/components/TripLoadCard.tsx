...
export const TripLoadCard: React.FC<TripLoadCardProps> = ({ trip, status, isSelected, onClick }) => {
    ...
    >
      ...
      <div className="flex justify-between items-center mb-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="font-bold text-slate-900 text-[16px] tracking-tight block">{orderNumber}</span>
          </div>
        </div>
      ...
      <div className="flex bg-slate-50/80 rounded-xl p-2.5 border border-slate-100 mb-5 text-center">
        <div className="flex-1 border-r border-slate-200/60 px-1">
          <p className="text-[10px] uppercase font-bold text-slate-500 tracking-wider mb-0.5">Driver</p>
          <p className="text-xs font-black text-slate-800 truncate">
             {driverName.split(' ')[0]}
          </p>
        </div>
        <div className="flex-1 border-r border-slate-200/60 px-1">
          <p className="text-[10px] uppercase font-bold text-slate-500 tracking-wider mb-0.5">Vehicle</p>
          <p className="text-xs font-black text-slate-800 truncate">
             {vehiclePlate}
          </p>
        </div>
        <div className="flex-1 border-r border-slate-200/60 px-1">
          <p className="text-[10px] uppercase font-bold text-slate-500 tracking-wider mb-0.5">Stops</p>
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-[13px] font-bold text-slate-900 leading-none mb-1 truncate max-w-[150px]">{customerName}</p>
