...
export const IconCheckCircle: React.FC<SVGProps<SVGSVGElement>> = ({
  className,
  ...props
}) => {
  ...
  return (
    ...
    >
      <path
        ...
        fill={useGradient ? "url(#paint0_linear_217_500)" : "currentColor"}
      />
      {useGradient && (
        <defs>
          <linearGradient
            id="paint0_linear_217_500"
            x1="12"
            y1="2"
            x2="12"
            y2="22"
          ...
          >
            <stop stop-color="var(--color1, currentColor)" />
            <stop offset="1" stop-color="var(--color2, currentColor)" />
          </linearGradient>
        </defs>
      )}
    </svg>
